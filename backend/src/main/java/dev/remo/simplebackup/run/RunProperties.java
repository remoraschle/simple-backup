 ...
 * @param postgresImage       Vorlage fuer das Image mit den PostgreSQL-Werkzeugen. Der
 *                            einzige Fall, in dem nicht das Runner-Image verwendet wird: Die
 *                            Hauptversion muss eingesetzt werden, weil pg_dump sich weigert,
 *                            eine neuere Datenbank zu lesen als es selbst kennt.
